...
//
   ...
   //Omitted  for now               editor.putString(KEY_TITLE+count,noteTitle.getText().toString() );
   //Omitted  for now                editor.putString(KEY_BODY+count++,noteBody.getText().toString() );
   //Omitted for now                  editor.commit();
                    ...
                    //The above lines direct to the files to sharedPref//
                }
            });
            alertBuilder.show();
        }
